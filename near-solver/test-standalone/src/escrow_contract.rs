...
pub struct EscrowContract {
    ...
    pub orders: HashMap<String, EscrowOrder>,
...
impl EscrowContract {
    ...
    pub fn fill_order(&mut self, order_id: String, preimage: String, caller: &str) -> Result<(), String> {
        // First, get the hashlock value to avoid borrowing conflicts
        let hashlock = {
        ...
        // Now get mutable reference and fill the order
    ...
    pub fn get_orders_by_maker(&self, maker: &str, from_index: usize, limit: usize) -> Vec<&EscrowOrder> {
